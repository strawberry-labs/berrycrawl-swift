...
final class HTTPClient: Swift.Sendable {
    ...
    func performRequest<T: Swift.Decodable>(
        ...
        if responseType == Foundation.Data.self {
            if let data = data as? T {
                ...
                throw BerrycrawlError.invalidResponse
            }
        }
        ...
        do {
            ...
            throw BerrycrawlError.decodingError(error)
        }
    }
    ...
    private func executeRequestWithURLSession(
        ...
        for attempt in 0...maxRetries {
            do {
                ...
                let clientError: BerrycrawlError?
                ...
                } else if let existingClientError = error as? BerrycrawlError {
                ...
                if attempt >= maxRetries || clientError != nil {
                    if let clientError {
                        ...
                        throw BerrycrawlError.networkError(error)
                    }
                }
    ...
    private func makeErrorFromResponse(statusCode: Swift.Int, data: Foundation.Data) -> BerrycrawlError
    {
        ...
        return BerrycrawlError.httpError(httpError)
    }
}
