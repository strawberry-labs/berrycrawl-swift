...
public struct JobResponseData: Codable, Hashable, Sendable {
    ...
    public let errors: [JobResponseDataErrorsItem]
    public let result: JSONValue?
    public let resultPagination: Pagination
    ...
    public init(
        ...
        total: Int,
        type: JobSummaryType,
        errors: [JobResponseDataErrorsItem],
        ...
        self.errors = errors
        self.result = result
        self.resultPagination = resultPagination
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.errors = try container.decode([JobResponseDataErrorsItem].self, forKey: .errors)
        self.result = try container.decodeIfPresent(JSONValue.self, forKey: .result)
        self.resultPagination = try container.decode(Pagination.self, forKey: .resultPagination)
        self.results = try container.decode([[String: JSONValue]].self, forKey: .results)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.resultPagination, forKey: .resultPagination)
